...
`r if(!knitr:::is_latex_output()) '# (APPENDIX) Appendix {-appPaleo}'`

# Appendix C: Paleodiatom case study: distance travelled, velocity, Fisher Information {-#appPaleo}
...
### Calculate the distance travelled and velocity metrics
...
Load the numerical differentiation results data. These finite differences were approximated in MatLab, using code that implements the methods found in [@chartrand_numerical_2011].
...
```{r paleoAppPlotAbundance, echo = FALSE, warning=F, message=F, cache = T}
...
### Calculate Fisher Information using moving window analysis

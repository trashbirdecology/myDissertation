...
# In which direction to run metrics?
...
if(!exists("usBaseMap") & rowEx.ind != 21) source("./chapterFiles/fisherSpatial/04-chap-fisherSpatial_baseMaps.R")
  ## using the if statement avoids us sourcing this if it has already been done
# c. Plot the distances

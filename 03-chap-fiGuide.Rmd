...
```{r dsdtOverTime, echo=FALSE,echo = F, warning=F, message = F, fig.cap=paste("Speed of the system (rate of change) in phase space. Dashed vertical line at time 200 indicates location of regime shift."), out.width = "75%"}

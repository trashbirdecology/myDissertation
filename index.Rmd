...
# format than PDF, you can delete or ignore the lines below.
...
# Chunk defaults
knitr::opts_chunk$set(cache = TRUE, message = FALSE, warning=FALSE, include = TRUE, echo=FALSE, tidy=TRUE, 
...
```{r include_packages, include = FALSE, cache = TRUE, echo=FALSE, warning=FALSE, eval=TRUE}

...
-->
```{r chunkOpts, include = T, echo=F, warning=F, message=F}
# Chunk defaults
knitr::opts_chunk$set(cache = T, message = F, warning=F, include =T, echo=F, 
                      fig.width=7, fig.height=7, fig.align='center', out.width = 7) 

```


```{r include_packages}
list.of.packages <- c("ggplot2", "devtools", "here", "dplyr", 

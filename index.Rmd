...
---
```{r installLoadPkgs, cache = TRUE, echo=FALSE, warning=FALSE, eval=TRUE, message=FALSE, results ='hide'}

## IS THSI A QUICKRUN???? FALSE if knitting a final doc, true will not knit all simulatiosn becaues time expensive
quickRun<-TRUE
...
myPackages <- c( "tidyverse", 
  ...
  "ggplot2", "ggthemes", "gapminder",
                      "devtools", "here", "dplyr", 
                     "bookdown", 
  # "envalysis", # publish theme plots
  "kableExtra", "gganimate", "sp", "raster", 
                      "feather", "maps", 
                      # "inlabru", # not sure why i was using this...
                      "gridExtra", 
...
# Chunk defaults
require(knitr)
knitr::opts_chunk$set(results = "hide", cache = TRUE, cache.path = "_cache/",

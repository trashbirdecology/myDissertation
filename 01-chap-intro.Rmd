...
**Chapter \@ref(discontinuity)**. This chapter presents an application of body mass discontinuity analysis to avian community time series before and after a proposed regime shift. A study by C.P. Roberts and others (in review) use discontinuity analysis to suggest decadal shifts of the avian community across a large region of the Central United States, corresponding to woody encroachment. Here, I apply these methods to local avian community data in areas that have undergone regime shfits according to the aforementioned study. In this study I was unable to identfiy clear patterns in the avian community body mass distributions using a before-and-after design. 

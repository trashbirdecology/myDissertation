...
```{r viCV, echo=FALSE, fig.pos="H", out.width="85%", fig.cap="Density plot of the coefficient of variation (CV) as a percentage (%) of the Variance Index resampled values over 10,000 iterations. Densities are drawn based on all values of CV but values >100% are not printed."}
...
```{r viResamp2, echo=FALSE, out.width="85%", fig.cap="Mean Variance Index (VI) and associated 95% confidence intervals over 10,000 iterations using the  __species__ resampling method. Red line indicates the value of VI when __M__ and __P__ = 100%."}

...
```{r results, out.width = "85%",  echo=FALSE,  fig.cap="Density plot of the coefficient of variation (CV) as a percentage (%) of the Fisher  Information bootstrapped samples (10,000 iterations). Densiies based on all values of CV, but values >100% are not printed."}

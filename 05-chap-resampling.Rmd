# Comparing the Robustness of Multivariate Regime Detection Measures to Varying Data Quality and Quantity Using Resampling {#resampling}
...
```{r fiResamp, out.width = "55%",  echo=FALSE,  fig.cap="Mean Fisher Information (FI) and associated 95% confidence intervals over 10,000 iterations using the observations (top panel) and species (bottom panel) resampling methods. Red line indicates the value of FI when M and P = 100%. Note the log-scale of FI values."}

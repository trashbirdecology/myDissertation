...
```{r sCV,echo=FALSE, out.width="85%", fig.cap="Density plot of the coefficient of variation (CV) as a percentage (%) of the Distance Metric (s) resampled samples (10,000 iterations). Densities are drawn based on all values of CV, but values >100% are not printed."}
knitr::include_graphics(loadFig("s_cvDensity"))
```

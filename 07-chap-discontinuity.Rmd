...
```{r routeGapEx, echo=FALSE, eval=TRUE,  out.width="85%", fig.cap="Aggregation locations of body mass distributions of the avian community at a single NABBS route (state 7 route 24) appear relatively similar across time."}
...
```
```{r bmDistPerSppGroup-perRegime, echo=FALSE, eval=TRUE, fig.cap="The body mass distribution of declining species appears to differ slightly between the Southern and Northern regimes.", out.width="85%"}

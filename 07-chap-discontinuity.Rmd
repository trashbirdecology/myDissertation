...
A recent study of the Central United States, including and beyond the Great Plains ecoregions, used discontinuity analysis of body mass distributions to identify the locations of what they refer to as 'spatial regimes' over an approximately 50 year period [@roberts2019shifting]. The authors concluded that a spatial regime boundary exists in this region, and has been moving pole-ward as a consequence of large-scale drivers including woody plant encroachment, fire suppression, and climate change. Using the boundaries identified in this study I seek to determine whether this 'shifting spatial regime' manifests in the grasslands of the Central Great Plains. 

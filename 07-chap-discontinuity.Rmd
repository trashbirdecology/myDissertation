...
```{r aggEdgeCorrPlot, echo=FALSE, eval=TRUE, fig.cap="Relationship between species richness per route and (a) the number of aggregations identified in body mass distributions and (b) distance to the edge (units log body mass) of aggregations.", out.width="80%"}
...
```{r intrxnPlot_regime, eval=FALSE, echo=FALSE, eval=TRUE, fig.cap=""}

...
##### Grassland obligates
The spatial regimes identified in @roberts2019spatial are attributed to large-scale changes in the landscape, including woody plant invasion. The loss of native grassland in our study area due to land conversion is largely attributed to anthropogenic land use change (e.g., development) and fire suppression. Numerous species have been negatively impacted by this widespread habitat loss, but grassland obligates are particularly at risk. I identified `r nrow(sppIntTab)` grassland obligate species potentially occurring in North America (Table \@ref(tab:sppIntTab)) from teh primary and grey literatures [@shriver2005distribution; @north2009state].
GOs declinilng accordin gto @north2009state from 1970-2003, when the farm bill was introduced...
Farm bill 2003 == leveling off but still major loss of GO

...
```{r stopTotalMean, echo=FALSE, eval=TRUE, fig.cap="Average coefficient of variation in the number of birds across the entire study area per species group per year."}

...
### Subset species by trait, body mass, taxonomically, etc...
...
For this (spatial) example, we will analyze only every fifth year in the available data. 

...
Long-lasting changes in the underlying structure or functioning of natural systems due to exogeneous forcings (regime shifts) is of interest to ecologists. The ability to identify and predict these shifts is particularly useful for systems which are actively managed, provide ecosystem services, or provide some other benefit to societies. The past few decades have seen a rapid increase in studies of regime shifts

There exists a disparity among the number of methods proposed for detecting abrupt changes in ecological, oceanographic, and climatological systems and those evaluated on empirical data. Despite the large number of existing methods and models, new methods continue to permeate the literature (@andersen_ecological_2009). 


Few reviews of these methods exist (@andersen_ecological_2009, @rodionov_brief_2005, @perretti2012regime)

In this chapter I review briefly the methods proposed as regime shift detection methods (RDMs)

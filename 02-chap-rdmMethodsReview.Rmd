...
I used the Thomson-ISI Web of Science (WoS) database to identify papers published prior to March 2019 that introduced new RDMs. The complete boolean was: 
...
where '*' indicates a wildcard. Other methods/papers that I was aware of were added if they did not appear in the search.  I then excluded papers based on abstracts-- if a paper did not indicate a new method, nor was the method(s) being used not familiar to me, I removed the paper from consideration. 

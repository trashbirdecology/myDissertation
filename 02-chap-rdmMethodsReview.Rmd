...
```{r thematicMaps_keyword_nvaries,echo=FALSE, fig.cap="Theme (cluster) identification varies with the number of keywords included in algorithm.", out.width="80%"}

...
DiagrammeR::grViz(
  ...
  data4 [label = 'Prior knowledge \nof  methods \n (n = 71)', shape = folder, fillcolor = Linen]
  
  results [label = 'Final list of \n methods \n (n = 73)', shape = folder, fillcolor = Grey]
...
The Web of Science search yielded `r nrow(wos.results)` unique articles, of which `r nrow(wos.filteredByHand)` were retained after filtering (Fig. \@ref(fig:rdmReviewFlow)). Of the `r 250` articles scanned in Google Scholar, 3 were retained. Using my prior knowledge of the relevant litearture and referring to methods presented in prior reviews [e.g., @rodionov_brief_2005], I identified `r nrow(metricsList.table)` unique RDMs (Figs. \@ref(fig:rdmReviewFlow), \@ref(fig:jrnlDistFig), \@ref(fig:jrnlYearFig)). 

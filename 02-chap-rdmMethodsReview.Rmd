...
Questions = tibble(Type = c(rep("Methodological", length(Questions.stat)), rep("Ecological", length(Questions.ecol))), 
                       Questions = c(Questions.stat, Questions.ecol))
require(kableExtra)
kableExtra::kable(Questions, "latex", longtable = T, booktabs = T,   caption = "Potential questions for a comprehensive review of the **ecological** regime detection metrics literature.") %>%

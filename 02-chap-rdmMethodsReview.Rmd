...
<!-- In addition to using expert experience, I used the snowball method to identify articles introducing new RSDMs.  -->

I used two methods to identify articles proposing 'new' RSDMs:
1. Systematic literature review
1. Prior knowledge and old review papers

### Systematic literature review using Web of Science

I conducted a systematic literature review using Web of Science/Web of Knowledge. I usd the following boolean: 
...
Including the term *threshold* increased the search yield approximately ten-fold, but the articles were irrelevant to my search. Therefore, I omitted this term from my boolean.
...
```{r methJrnlsFigs, echo=F, eval=T, cache = T, message=F, warning=F, out.width = "45%", fig.cap="Distribution of articles related to ecological regime shift methodologies and frameworks published in the first and second quartiles of SJR *ecology* journals and in *Methods in Ecology and Ecolution* and *Ecological Modelling*."}
# Visualize results
...
grid.arrange(ptemp1, ptemp2, ncol=2)
```

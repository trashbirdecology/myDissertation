...
My list of methods does not make reference to the numerous publications which have recycled or have made slight adaptations to previously existing methods [@byrski2016double; @salehpour2011line; @zhou2008one]. However, see  @nicholls2011biological for an addition of variable optimization to the method in @nicholls_detection_2011 that was not included in my comprehensive list. Finally, my list excludes papers which propose a  combination of existing methods [e.g., @kong2017hydrological; @seddon2014quantitative; @vasilakopoulos2017resilience]. 
\pagebreak[4]

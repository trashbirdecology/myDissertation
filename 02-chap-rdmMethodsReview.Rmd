...
Numerous reviews of the regime shift literature exist, including a few specially reviewing the available regime detection methods. Fewer have reviewed the efficacy or robustness of multiple RDMs using real world ecological data [but see @;@;@]. 

...
## State of the regime shift method literature
...
Numerous reviews of the regime shift literature exist, ranging from conceptual reviews of the state of regime shift theory in ecology [@], to studies of robustness of early warning indicators under various theoretical and practical conditions [@dutta2018robustness; @perretti2012regime; @lindegren2012early; @hastings2010regime].

including a few specially reviewing the available regime detection methods. Fewer have reviewed the efficacy or robustness of multiple RDMs using real world ecological data [but see @;@;@]. 

Further, these reviews are increasingly out-dated given the uptick in recent years of research articles focused on regime shift theory and detection. A permanent and open-source database containing information critical to the implementation of RDMs would be a useful resource for those interested in applying RDMs but lacking the statistical or mathematical background to do so. 

[@rodionov_brief_2005; @roberts2018early; @mantua_methods_2004; @andersen_ecological_2009; @dakos2015resilience; @mac2014scrutiny; @scheffer2015generic; @boettiger_early_2013;  @litzow_early_2016; ] 

[ @dakos2010regime; @ditlevsen2010tipping ]

 @kefi2014early; 
 ; @clements2018indicators; 
 @filatova2016regime; 
 @deyoung_regime_2008

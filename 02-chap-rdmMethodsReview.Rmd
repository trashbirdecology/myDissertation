...
I used three 'methods' to identify articles proposing 'new' RSDMs:
1. prior knowledge,
1. snowball method baded on past RDM reviews, and
1. systematic literature review

It is worth noting that the latter 'method', although designed to identify all possible RDMs, does not fully overlap with the methods identified using the first two. The reasons for this will be discussed further in discussion. 

...
kableExtra::kable(long_dt,
      ...
      booktabs =TRUE,
      caption = "List of the regime detection methods identified in this review and the original sources.") %>%

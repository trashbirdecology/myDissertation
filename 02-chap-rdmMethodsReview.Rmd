...
I attempted to compose a comprehensive list of the published quantitative regime detection measures by conducting a systematic literature review. Despite multiple attempts at defining booleans to identify the greatest number of methods in the literature, no single boolean yielded the majority of methods of which I was previously aware. In light of this, I also relied on my prior knowledge of available regime detection measures to build the database. 

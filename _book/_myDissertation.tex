...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ dist.sim }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(sim.num}\OperatorTok{==}\DecValTok{1}\NormalTok{, t}\OperatorTok{==}\DecValTok{51}\NormalTok{), }

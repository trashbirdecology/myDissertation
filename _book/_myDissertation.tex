...
\addcontentsline{toc}{subsection}{Bibliographic analysis of the ecological regime shift literature}
...
{\centering \includegraphics[width=0.75\linewidth]{_myDissertation_files/figure-latex/wosRegimePubsByJrnl-1} 

}

\caption{Number of articles containing phrases related to ecological 'regime shifts' published per publication outlet.}\label{fig:wosRegimePubsByJrnl}
\end{figure}
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/rdmReview/figures/figsCalledInDiss/thematicMaps-keywords} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/rdmReview/figures/figsCalledInDiss/thematicMaps-keywords-nVaries-author} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/rdmReview/figures/figsCalledInDiss/thematicMaps-keywords-nVaries-isi} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/rdmReview/figures/figsCalledInDiss/historiograph-75quantile} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/rdmReview/figures/figsCalledInDiss/totArtCitesPerYear} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/rdmReview/figures/figsCalledInDiss/revArtNums} 
...
{\centering \includegraphics[width=0.95\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/fiGuide/figures/distSppedAccel} 
...
{\centering \includegraphics[width=0.95\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/fiGuide/figures/kTrajectories} 
...
{\centering \includegraphics[width=0.95\linewidth]{./chapterFiles/fiGuide/figures/sOverTime} 

}

\caption{Distance travelled in phase space over time. Dashed vertical line at time 200 indicates location of regime shift.}\label{fig:sOverTime}
\end{figure}
...
{\centering \includegraphics[width=0.95\linewidth]{./chapterFiles/fiGuide/figures/fiOverTime} 
...
\caption{Three East-West running transects analyzed in this Chapter overlayed against the Omernick Ecoregion boundaries map.}\label{fig:ewRoutesUsedHere}
\end{figure}
...
\caption{The change in the Fisher Information  values along a single,  East-West-running spatial transect (Transect number 12) over time.}\label{fig:fi1Tsect}
\end{figure}
...
\caption{Fisher Information of two spatially adjacent transect pairs (transects 12, 13) over time. Interdecadual trends in FI are very different within each transect and are not highly correlated among transects over time.}\label{fig:fiSinglePair}
\end{figure}
\begin{landscape}
\begin{figure}[bth]

{\centering \includegraphics[width=0.65\linewidth]{./chapterFiles/fisherSpatial/figures/figsCalledInDiss/usaAllTsects_East-West_metric_logScaleFI} 

}

\caption{Fisher Information of select East-West spatial transects over time. These transects are representative of the results obtained from the remaining transects.}\label{fig:usaFI}
\end{figure}
\end{landscape}
\begin{figure}[bth]
...
\caption{Fisher Information results (scaled and centered; larger circles (points) represent higher values of Fisher Information) plotted against ecoregion boundaries (EPA Level 2 boundaries) for the year 2000.}\label{fig:fiEcoregion00}
\end{figure}
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/lorenz3D} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/lorenz3D_timeseries} 
...
{\centering \includegraphics[width=0.85\linewidth]{_myDissertation_files/figure-latex/sysExs-1} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/velocitySysEx1} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/simVplot1} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/simVplot2} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/simVarPlot} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/simVarPlot2} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/smoothV} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/changeMuBoth_tanhAlpha025-05tvdiffAlpha-1000iter_origDat} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/changeMuBoth_tanhAlpha1-100tvdiffAlpha-1000iter_origDat} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/velocity/figsCalledInDiss/compareTvdiff_s_changeMuX1_tanhAlpha1-05tvdiffAlpha-1000iter} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/changeMuX1_tanhAlpha025-05tvdiffAlpha-1000iter_stackTvdiff} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/changeMuX1_tanhAlpha05-05tvdiffAlpha-1000iter_stackTvdiff} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/changeMuX1_tanhAlpha075-05tvdiffAlpha-1000iter_stackTvdiff} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/changeMuX1_tanhAlpha1-05tvdiffAlpha-1000iter_stackTvdiff} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/changeMuBoth_tanhAlpha075-05tvdiffAlpha-1000iter_stackTvdiff} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/changeVarBoth_tanhAlpha075-5tvdiffAlpha-1000iter_stackTvdiff} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/changeVarX1_tanhAlpha075-10tvdiffAlpha-1000iter_stackTvdiff} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/changeMuBoth_tanhAlpha025-05tvdiffAlpha-1000iter_stackTvdiff} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/changeMuVarBoth_tanhAlpha025-5tvdiffAlpha-1000iter_stackTvdiff} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/changeMuVarBoth_tanhAlpha1-10tvdiffAlpha-1000iter_stackTvdiff} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/paleoTurnover} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/paleoVelocity} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/paleoRegime1and3} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/paleoObsPred} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/velocity/figsCalledInDiss/paleoV} 
...
{\centering \includegraphics[width=0.75\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/resampling/figsCalledInDiss/timeElapsed} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/resampling/figsCalledInDiss/VI_cvDensity} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/resampling/figsCalledInDiss/VI_observations_ribboned_facetByProb} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/resampling/figsCalledInDiss/VI_species_ribboned_facetByProb} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/resampling/figsCalledInDiss/dsdt_observations_ribboned_facetByProb} 
...
{\centering \includegraphics[width=0.75\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/resampling/figsCalledInDiss/dsdt_observations_ribboned_facetByProb_regime2} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/resampling/figsCalledInDiss/s_cvDensity} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/resampling/figsCalledInDiss/FI_cvDensity} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/resampling/figsCalledInDiss/logFI_species_ribboned_facetByProb} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation/chapterFiles/resampling/figsCalledInDiss/loess} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/discontinuityAnalysis/figsCalledInDiss/mybbox_onBCRmap} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/discontinuityAnalysis/figsCalledInDiss/routes_spatRegimeLines2} 
...
{\centering \includegraphics[width=0.85\linewidth]{_myDissertation_files/figure-latex/nRtesPerRegimePerYearFig-1} 

}

\caption{Number of NABBS routes analysed per year. Some routes are not sampled annually due to volunteer availability, environmental conditions, or route discontinuation.}\label{fig:nRtesPerRegimePerYearFig}
\end{figure}
\begin{figure}[bth]

{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/discontinuityAnalysis/figsCalledInDiss/richnessByYear} 

}

\caption{Species richness increases over time across the entire study area.}\label{fig:richnessByYear}
\end{figure}
\begin{figure}[bth]

{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/discontinuityAnalysis/figsCalledInDiss/turnoverByYear} 

}

\caption{Variance in the total species turnover increases over time across the entire study area.}\label{fig:turnoverByYear}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/discontinuityAnalysis/figsCalledInDiss/intrxnPlot_regime} 
...
{\centering \includegraphics[width=0.8\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/discontinuityAnalysis/figsCalledInDiss/intrxnPlot_regime1} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/discontinuityAnalysis/figsCalledInDiss/stopTotal-byBCR-logSum} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/discontinuityAnalysis/figsCalledInDiss/stopTotal-byBCR-mean} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/discontinuityAnalysis/figsCalledInDiss/stopTotal-byBCR-CV} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/discontinuityAnalysis/figsCalledInDiss/distEdge_corrplot} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/discontinuityAnalysis/figsCalledInDiss/routeGapEx} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/discontinuityAnalysis/figsCalledInDiss/bmDistPerSppGroup} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/discontinuityAnalysis/figsCalledInDiss/bmDistPerSppGroup-byRegime} 
...
{\centering \includegraphics[width=0.85\linewidth]{/Users/jessicaburnett/Documents/GitHub/myDissertation//chapterFiles/discontinuityAnalysis/figsCalledInDiss/bmDistPerSppGroup-byBCR} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{regionFileName.use <-}\StringTok{ "Florida.zip"}

\ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\KeywordTok{exists}\NormalTok{(}\StringTok{"regionFileName.use"}\NormalTok{))\{}
\NormalTok{  regionFileName <-}\StringTok{ }\NormalTok{regions}\OperatorTok{$}\NormalTok{zipFileName }\OperatorTok{%>%}\StringTok{ }\KeywordTok{na.omit}\NormalTok{()}
\NormalTok{  (regionFileName.use <-}\StringTok{ }\NormalTok{regionFileName[}\KeywordTok{which}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(regionFileName, }\StringTok{"Flori"}\NormalTok{)}\OperatorTok{==}\OtherTok{TRUE}\NormalTok{)])}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{routes <-}\StringTok{ }\KeywordTok{get_routeInfo}\NormalTok{() }\CommentTok{# retrieve route-level data}
\NormalTok{flBBS <-}\StringTok{ }\KeywordTok{left_join}\NormalTok{(flBBS, routes) }\CommentTok{# merge route-level data to bird count data}
\KeywordTok{glimpse}\NormalTok{(flBBS }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(aou, year, route, statenum, countrynum, stoptotal, latitude, longitude))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{subset_speciesList}\NormalTok{(}\DataTypeTok{myData =}\NormalTok{ flBBS, }\DataTypeTok{aou.ind =} \DecValTok{06882}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{glimpse}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{flBBS <-}\StringTok{ }\KeywordTok{left_join}\NormalTok{(flBBS, spp)}
\NormalTok{hospBBS <-}\StringTok{ }\NormalTok{flBBS }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(commonName}\OperatorTok{==}\StringTok{"House Sparrow"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{results <-}\StringTok{ }\KeywordTok{get_analysis_results}\NormalTok{(}\DataTypeTok{analysis =} \StringTok{"trend.ests"}\NormalTok{) }\CommentTok{# default here is to obtain the 1966-2015 species trend estimates}
\NormalTok{results.flHOSP <-}\StringTok{ }\NormalTok{results }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Species.Name}\OperatorTok{==}\StringTok{"House Sparrow"}\NormalTok{, Region.Code}\OperatorTok{==}\StringTok{"FLA"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ results }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(AOU.Number}\OperatorTok{==}\StringTok{'s06882'}\NormalTok{,}
\NormalTok{                   Region.Code}\OperatorTok{==}\StringTok{"S05"}\NormalTok{),}
       \KeywordTok{aes}\NormalTok{(Year, Annual.Index))}\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{y=}\StringTok{"HOSP annual population }\CharTok{\textbackslash{}n}\StringTok{trend index in region S05"}\NormalTok{)}\OperatorTok{+}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cred <-}\StringTok{ }\KeywordTok{get_credibility_trends}\NormalTok{() }\CommentTok{# default here is Florida House Sparrows.}

\CommentTok{# credibility colors correspond with the color scheme used on the BBS results page}
\NormalTok{cred }\OperatorTok{%>%}\StringTok{ }\KeywordTok{distinct}\NormalTok{(credibilityNumber, credibilityColor, credibilityClass)}
\end{Highlighting}
\end{Shaded}
Trend estimates are also listed in \texttt{cred} for Florida House Sparrow data:
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cred }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(Species }\OperatorTok{==}\StringTok{ "House Sparrow"}\NormalTok{) }\OperatorTok{%>%}
...
First, visit the USGS Patuxent Wildlife Research Center's \href{https://www.mbr-pwrc.usgs.gov/}{website for BBS results} Online \url{https://www.mbr-pwrc.usgs.gov/}. Next, enable the drop-down \textbf{Survey Results}, and choose \textbf{Trend Estimates (by region)} (left) and choose the desired region (e.g.~Florida):
\includegraphics[width=3.125in,height=\textheight]{./chapterFiles/appendices/regcred_select_trendests_byregion.png}\includegraphics{./chapterFiles/appendices/regcred_select_fl.png}
...
\hypertarget{calculate-metrics-analysis}{%
\subsection{Calculate Metrics analysis}\label{calculate-metrics-analysis}}
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\NormalTok{opts_chunk}\OperatorTok{$}\KeywordTok{set}\NormalTok{(}\DataTypeTok{echo=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{eval=}\OtherTok{FALSE}\NormalTok{, }\DataTypeTok{message=}\OtherTok{FALSE}\NormalTok{, }\DataTypeTok{warning=}\OtherTok{FALSE}\NormalTok{, }\DataTypeTok{out.width =} \StringTok{"85%"}\NormalTok{)}

\KeywordTok{library}\NormalTok{(regimeDetectionMeasures)}

\CommentTok{# Munge original data -----------------------------------------------------}
\NormalTok{origData =}\StringTok{ }\KeywordTok{munge_orig_dat}\NormalTok{(}\DataTypeTok{example =}\NormalTok{ T)}
\end{Highlighting}
\end{Shaded}
\hypertarget{plots}{%
...
\begin{Highlighting}[]
\CommentTok{# a. Load the regional .txt file from Patuxent's FTP server (you must be connected to the internet to perform this step)}
\NormalTok{regions <-}\StringTok{ }\KeywordTok{GetRegions}\NormalTok{()}

\CommentTok{# b. Create a series or one filenames for states, regions}
\NormalTok{regionFileName <-}\StringTok{ }\NormalTok{regions}\OperatorTok{$}\NormalTok{zipFileName }\OperatorTok{%>%}\StringTok{ }\KeywordTok{na.omit}\NormalTok{()}

\CommentTok{# c.  Download and unzip the BBS data.}
\ControlFlowTok{if}\NormalTok{(downloadBBSData}\OperatorTok{==}\OtherTok{TRUE}\NormalTok{)\{}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(regionFileName))\{}
\NormalTok{        bbsData <-}\StringTok{  }\KeywordTok{importDataBBS}\NormalTok{(}
            \CommentTok{# arguments for getDataBBS()}
            \DataTypeTok{file =}\NormalTok{ regionFileName[i],}
            \DataTypeTok{dir =}  \StringTok{"ftp://ftpext.usgs.gov/pub/er/md/laurel/BBS/DataFiles/States/"}\NormalTok{,}
            \DataTypeTok{year =} \OtherTok{NULL}\NormalTok{,}
            \DataTypeTok{aou =} \OtherTok{NULL}\NormalTok{,}
            \DataTypeTok{countrynum =} \OtherTok{NULL}\NormalTok{,}
            \DataTypeTok{states =} \OtherTok{NULL}\NormalTok{,}
            \CommentTok{#  arguments for getRouteInfo():}
            \DataTypeTok{routesFile =} \StringTok{"routes.zip"}\NormalTok{,}
            \DataTypeTok{routesDir =}  \StringTok{"ftp://ftpext.usgs.gov/pub/er/md/laurel/BBS/DataFiles/"}\NormalTok{,}
            \DataTypeTok{RouteTypeID =} \DecValTok{1}\NormalTok{,}
            \CommentTok{# one or more of c(1,2,3)}
            \DataTypeTok{Stratum =} \OtherTok{NULL}\NormalTok{,}
            \DataTypeTok{BCR =} \OtherTok{NULL}
\NormalTok{        )}


\CommentTok{# d. Save the unzipped files to disk.}
\KeywordTok{birdsToFeathers}\NormalTok{(}\DataTypeTok{dataIn  =}\NormalTok{ bbsData,}
                \DataTypeTok{newDir  =}\NormalTok{ bbsDir,}
                \DataTypeTok{filename =}\NormalTok{ regionFileName[i])}
\CommentTok{# e. Clear object from memory}
\KeywordTok{rm}\NormalTok{(bbsData)}
\NormalTok{\} }\CommentTok{# end section I. loop}
\NormalTok{\}}\ControlFlowTok{else}\NormalTok{(}\KeywordTok{print}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{"NOT DOWNLOADING BBS DATA. If you wish to download the BBS data, please remove files from directory: "}\NormalTok{,bbsDir))) }\CommentTok{# end if-else to download the data}
\end{Highlighting}
\end{Shaded}
\hypertarget{create-a-sampling-grid}{%
\subsection{Create a sampling grid}\label{create-a-sampling-grid}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# III: Build sampling grid --------------------------------------------------------}
\CommentTok{# Define the grid's cell size (lat, long; unit:degrees)}
        \CommentTok{## 1 deg latitude ~= 69 miles}
        \CommentTok{## 1 deg longitude ~= 55 miles}
\NormalTok{cs <-}
\StringTok{    }\KeywordTok{c}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\FloatTok{0.5}\NormalTok{)  }\CommentTok{# default is cell size 0.5 deg lat x 0.5 deg long}

\CommentTok{# Create the grid}
\NormalTok{routes_gridList <-}\StringTok{ }\KeywordTok{createSamplingGrid}\NormalTok{(}\DataTypeTok{cs =}\NormalTok{ cs)}

\CommentTok{# Define the components of the sampling grid as individual objects}
\NormalTok{routes_grid <-}\StringTok{ }\NormalTok{routes_gridList}\OperatorTok{$}\NormalTok{routes_grid}
\NormalTok{sp_grd <-}\StringTok{ }\NormalTok{routes_gridList}\OperatorTok{$}\NormalTok{sp_grd}
\KeywordTok{rm}\NormalTok{(cs)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tempResultsDir <-}\StringTok{ }\NormalTok{here}\OperatorTok{::}\KeywordTok{here}\NormalTok{(}\StringTok{"/tempFiles_bbsRDM/"}\NormalTok{)}
\KeywordTok{dir.create}\NormalTok{(tempResultsDir)}
\NormalTok{fns <-}\StringTok{ }\KeywordTok{list.files}\NormalTok{(tempResultsDir)}
\NormalTok{import.ind =}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}\KeywordTok{length}\NormalTok{(fns)}\OperatorTok{!=}\DecValTok{0} \OperatorTok{%in%}\StringTok{ }\NormalTok{fns, }\OtherTok{TRUE}\NormalTok{,}\OtherTok{FALSE}\NormalTok{)}
\NormalTok{import.feathers <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}\StringTok{"feathers.RDS"} \OperatorTok{%in%}\StringTok{ }\KeywordTok{list.files}\NormalTok{(tempResultsDir), }\OtherTok{FALSE}\NormalTok{, }\OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{if}\NormalTok{(import.feathers)\{}
\NormalTok{feathers <-}\StringTok{ }\OtherTok{NULL}
\NormalTok{featherNames <-}\StringTok{ }\KeywordTok{list.files}\NormalTok{(bbsDir, }\DataTypeTok{pattern =} \StringTok{".feather"}\NormalTok{)}
\NormalTok{featherNames <-}\StringTok{ }\KeywordTok{str_c}\NormalTok{(}\StringTok{"/"}\NormalTok{, featherNames) }\CommentTok{#add separator}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(featherNames)) \{}
\NormalTok{  feather <-}\StringTok{ }\OtherTok{NULL}
\NormalTok{  feather <-}\StringTok{ }\KeywordTok{loadBirdFeathers}\NormalTok{(}\DataTypeTok{newDir  =}\NormalTok{ bbsDir,}
                              \DataTypeTok{filename =}\NormalTok{ featherNames[i])}

\NormalTok{  feather <-}\StringTok{ }\NormalTok{feather }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{rename}\NormalTok{(}\DataTypeTok{lat =}\NormalTok{ latitude,}
                  \DataTypeTok{long =}\NormalTok{ longitude) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{left_join}\NormalTok{(routes_grid, }\DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"countrynum"}\NormalTok{, }\StringTok{"statenum"}\NormalTok{, }\StringTok{"route"}\NormalTok{, }\StringTok{"lat"}\NormalTok{, }\StringTok{"long"}\NormalTok{))}

\NormalTok{  feathers <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(feathers, feather)}
  \KeywordTok{rm}\NormalTok{(feather)}
  \ControlFlowTok{if}\NormalTok{(i }\OperatorTok{==}\StringTok{ }\KeywordTok{length}\NormalTok{(featherNames)) }\KeywordTok{saveRDS}\NormalTok{(feathers, }\KeywordTok{paste0}\NormalTok{(tempResultsDir, }\StringTok{"feathers.RDS"}\NormalTok{))}
\NormalTok{\}\}}\ControlFlowTok{else}\NormalTok{(feathers <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(tempResultsDir, }\StringTok{"feathers.RDS"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
\hypertarget{subset-the-bbs-data-by-species-andor-functional-traits-optional-but-highly-recommended}{%
\subsection{Subset the BBS data by species and/or functional traits (OPTIONAL but highly recommended)}\label{subset-the-bbs-data-by-species-andor-functional-traits-optional-but-highly-recommended}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Which metrics do you want to calculate?}
\NormalTok{metrics.to.calc <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"distances"}\NormalTok{, }\StringTok{"ews"}\NormalTok{)}

\CommentTok{# If calculating "EWSs, you can calculate select metrics.}
\CommentTok{## Default = all early-warning signals, FI, and VI}
\NormalTok{to.calc =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"EWS"}\NormalTok{, }\StringTok{"FI"}\NormalTok{, }\StringTok{"VI"}\NormalTok{)}

\CommentTok{# Choose spatial or temporal analysis}
\NormalTok{direction <-}
\StringTok{    "South-North"} \CommentTok{# choose one of : 'South-North', 'East-West', or 'temporal'}

\CommentTok{# Choose the fill value for species present in the entire time series (or sampling transect) but not present on that year. Using "NA" assumes the species with missing data *was not and could not have been present*. Using zero assumes the species could have been present but was not.}
\NormalTok{fill =}\StringTok{ }\DecValTok{0}

\CommentTok{# Minimum number of sites (if spatial) or years (if temporal)  required to be in the entire sample (trnasect or time series)}
\NormalTok{min.samp.sites =}\StringTok{ }\DecValTok{8}

\CommentTok{# Minimum number of sites (if spatial) or years (if temporal) required to be within a single window}
\NormalTok{min.window.dat =}\StringTok{ }\DecValTok{3}

\CommentTok{# Which Equation of Fisher Information to use (default = 7.12)}
\NormalTok{fi.equation =}\StringTok{ "7.12"}

\CommentTok{# By what % of the entire data should the window move?}
\NormalTok{winMove =}\StringTok{ }\FloatTok{0.25}

\CommentTok{# Define some filtering and labeling parameters based on direction of spatial analysis (if applicable)}

\ControlFlowTok{if}\NormalTok{ (direction }\OperatorTok{==}\StringTok{ "South-North"}\NormalTok{) \{}
\NormalTok{    dir.use =}\StringTok{  }\KeywordTok{unique}\NormalTok{(feathers}\OperatorTok{$}\NormalTok{colID) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{na.omit}\NormalTok{(colID) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{sort}\NormalTok{()\}}
\ControlFlowTok{if}\NormalTok{ (direction }\OperatorTok{==}\StringTok{ "East-West"}\NormalTok{) \{}
\NormalTok{    dir.use =}\StringTok{ }\KeywordTok{unique}\NormalTok{(feathers}\OperatorTok{$}\NormalTok{rowID) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{na.omit}\NormalTok{(rowID) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{sort}\NormalTok{()\}}
\end{Highlighting}
\end{Shaded}
Define the years we want to analyze. For this (spatial) example, we will analyze only every fifth year in the available data.
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Get all possible years}
\NormalTok{years.use =}\StringTok{ }\KeywordTok{unique}\NormalTok{(feathers}\OperatorTok{$}\NormalTok{year)}

\CommentTok{# Keep only the years which are divisible by T}
\NormalTok{T =}\StringTok{ }\DecValTok{10}
\NormalTok{years.use  <-}\StringTok{ }\NormalTok{years.use[}\KeywordTok{which}\NormalTok{(years.use }\OperatorTok{%%}\StringTok{ }\NormalTok{T }\OperatorTok{==}\StringTok{ }\DecValTok{0} \OperatorTok{&}\StringTok{ }\NormalTok{years.use }\OperatorTok{>}\StringTok{ }\DecValTok{1975}\NormalTok{)] }\OperatorTok{%>%}\StringTok{ }\KeywordTok{sort}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
\hypertarget{conduct-analysis}{%
\subsection{Conduct analysis}\label{conduct-analysis}}

This section will loop through \texttt{years.use} and \texttt{dir.use}, running each BBS route (temooral analysis) or spatial transect by year (spatial analysis) at a time. Results are saved in directories created earlier.
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# **Please note: depending on the # of years and spatial transects, this could take a while!**}
\ControlFlowTok{if}\NormalTok{(import.ind}\OperatorTok{==}\OtherTok{FALSE}\NormalTok{) }\ControlFlowTok{for}\NormalTok{ (j }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(dir.use)) \{}
    \CommentTok{# For east-west analysis}
        \ControlFlowTok{if}\NormalTok{ (direction }\OperatorTok{==}\StringTok{ "East-West"}\NormalTok{)\{}
\NormalTok{            birdsData <-}\StringTok{ }\NormalTok{feathers }\OperatorTok{%>%}
\StringTok{                }\KeywordTok{filter}\NormalTok{(rowID }\OperatorTok{==}\StringTok{ }\NormalTok{dir.use[j]) }\OperatorTok{%>%}
\StringTok{                }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{direction =}\NormalTok{ direction,}
                       \DataTypeTok{dirID =}\NormalTok{ dir.use[j])}
\NormalTok{    \}}
    \CommentTok{# For south-north analysis}
        \ControlFlowTok{if}\NormalTok{ (direction }\OperatorTok{==}\StringTok{ "South-North"}\NormalTok{)\{}
\NormalTok{            birdsData <-}\StringTok{ }\NormalTok{feathers }\OperatorTok{%>%}
\StringTok{            }\KeywordTok{filter}\NormalTok{(colID }\OperatorTok{==}\StringTok{ }\NormalTok{dir.use[j]) }\OperatorTok{%>%}
\StringTok{            }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{direction =}\NormalTok{ direction,}
                   \DataTypeTok{dirID =}\NormalTok{ dir.use[j])}
\NormalTok{    \}}

    \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{nrow}\NormalTok{(birdsData) }\OperatorTok{<}\StringTok{ }\NormalTok{min.samp.sites) \{}
        \ControlFlowTok{next}\NormalTok{(}\KeywordTok{print}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{"Not enough data to analyze. Skipping j-loop "}\NormalTok{, dir.use[j])))}
\NormalTok{    \}}

    \CommentTok{# VX.  Analyze the data ---------------------------------------------------}

    \ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(years.use))\{}
        \CommentTok{# a. Subset the data according to year, colID, rowID, state, country, etc.x}
\NormalTok{        birdData <-}\StringTok{ }\NormalTok{birdsData }\OperatorTok{%>%}
\StringTok{            }\KeywordTok{filter}\NormalTok{(year }\OperatorTok{==}\StringTok{ }\NormalTok{years.use[i]) }\OperatorTok{%>%}
\StringTok{            }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{rename}\NormalTok{(}\DataTypeTok{variable =}\NormalTok{ aou,}
                          \DataTypeTok{value =}\NormalTok{ stoptotal)}

        \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{nrow}\NormalTok{(birdData) }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{)\{}
            \ControlFlowTok{next}
\NormalTok{        \}}

        \CommentTok{# b. Munge the data further}
\NormalTok{        birdData <-}\StringTok{ }\KeywordTok{mungeSubsetData}\NormalTok{(birdData)}

        \CommentTok{# X.   Calculate the metrics ---------------------------------------------------}
        \CommentTok{## This function analyzes the data and writes results to file (in subdirectory 'myResults') as .feather files.}
\CommentTok{# browser()}
        \KeywordTok{calculateMetrics}\NormalTok{(}\DataTypeTok{dataIn =}\NormalTok{ birdData, metrics.to.calc, }\DataTypeTok{direction =}\NormalTok{ direction,  }\DataTypeTok{yearInd =}\NormalTok{ years.use[i])}

        \KeywordTok{print}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{"End i-loop (years) "}\NormalTok{, i, }\StringTok{" of "}\NormalTok{,  }\KeywordTok{length}\NormalTok{(years.use)))}

\NormalTok{    \} }\CommentTok{# end i-loop}

    \KeywordTok{print}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{"End j-loop (transects) "}\NormalTok{, j, }\StringTok{" of "}\NormalTok{,  }\KeywordTok{length}\NormalTok{(dir.use)))}
\NormalTok{\} }\CommentTok{# end j-loop}
\end{Highlighting}
\end{Shaded}
\hypertarget{import-and-munge-the-results-to-prepare-for-visualization}{%
\subsection{Import and munge the results to prepare for visualization}\label{import-and-munge-the-results-to-prepare-for-visualization}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#  Import EWS results}
\ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\StringTok{"results_ews.RDS"} \OperatorTok{%in%}\StringTok{ }\NormalTok{fns)\{results_ews <-}
\StringTok{    }\KeywordTok{importResults}\NormalTok{(}\DataTypeTok{resultsDir =}\NormalTok{ resultsDir, }\DataTypeTok{myPattern =} \StringTok{'ews'}\NormalTok{,}
                  \DataTypeTok{subset.by =}\NormalTok{ direction) }\OperatorTok{%>%}
\StringTok{    }\CommentTok{# assign the end of the window as the cellID}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{cellID =}\NormalTok{ cellID_max)}
  \KeywordTok{saveRDS}\NormalTok{(results_ews, }\DataTypeTok{file =} \KeywordTok{paste0}\NormalTok{(tempResultsDir, }\StringTok{"results_ews.RDS"}\NormalTok{))\}}
\CommentTok{## FYI: rows will likely be absent when metricTypes = c(FI, VI), because FI and VI are calculated across multiple variables (species), rather than calculated for individual variables.}

\CommentTok{#  Import distance results}
\ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\StringTok{"results_dist.RDS"} \OperatorTok{%in%}\StringTok{ }\NormalTok{fns)\{ results_dist <-}
\StringTok{    }\KeywordTok{importResults}\NormalTok{(}\DataTypeTok{resultsDir =}\NormalTok{ resultsDir, }\DataTypeTok{myPattern =} \StringTok{'distances'}\NormalTok{, }\DataTypeTok{subset.by =}\NormalTok{ direction)}

    \KeywordTok{saveRDS}\NormalTok{(results_dist, }\DataTypeTok{file =} \KeywordTok{paste0}\NormalTok{(tempResultsDir, }\StringTok{"results_dist.RDS"}\NormalTok{))\}}

\ControlFlowTok{if}\NormalTok{(import.ind)\{}
\NormalTok{  fn =}\StringTok{ }\KeywordTok{list.files}\NormalTok{(tempResultsDir, }\StringTok{"results_ews"}\NormalTok{, }\DataTypeTok{full.names =}\NormalTok{ T)}
\NormalTok{  results_ews <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(fn)}
\NormalTok{  fn =}\StringTok{ }\KeywordTok{list.files}\NormalTok{(tempResultsDir, }\StringTok{"results_dist"}\NormalTok{, }\DataTypeTok{full.names =}\NormalTok{ T)}
\NormalTok{  results_dist <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(fn)}
  \KeywordTok{rm}\NormalTok{(fn)}
\NormalTok{\}  }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#  Get the spatial sampling grid coordinates}
\NormalTok{coords_grd <-}
\StringTok{    }\KeywordTok{cbind}\NormalTok{(routes_gridList}\OperatorTok{$}\NormalTok{sp_grd}\OperatorTok{@}\NormalTok{data,}
          \KeywordTok{coordinates}\NormalTok{(routes_gridList}\OperatorTok{$}\NormalTok{sp_grd)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{lat =}\NormalTok{ s2,}
           \DataTypeTok{long =}\NormalTok{ s1,}
           \DataTypeTok{cellID  =}\NormalTok{ id)}

\CommentTok{# Join coords_grd with results}
\CommentTok{# note: a full join will likely produce many cells with NO results data..}
\CommentTok{# but NO lat or long should == NA!}
\NormalTok{distResults <-}
\StringTok{    }\KeywordTok{full_join}\NormalTok{(coords_grd,}
\NormalTok{              results_dist) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{na.omit}\NormalTok{(metricType)}

\NormalTok{ewsResults <-}
\StringTok{    }\KeywordTok{full_join}\NormalTok{(coords_grd,}
\NormalTok{              results_ews) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{na.omit}\NormalTok{(metricType) }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{cellID_min,}\OperatorTok{-}\NormalTok{cellID_max, }\OperatorTok{-}\NormalTok{winStart  , }\OperatorTok{-}\NormalTok{winStop)}

\CommentTok{# d. Set coordinate system and projection}
\KeywordTok{coordinates}\NormalTok{(distResults) <-}
\StringTok{    }\KeywordTok{coordinates}\NormalTok{(ewsResults) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"long"}\NormalTok{, }\StringTok{"lat"}\NormalTok{)}
\NormalTok{sp}\OperatorTok{::}\KeywordTok{proj4string}\NormalTok{(distResults) <-}
\StringTok{    }\NormalTok{sp}\OperatorTok{::}\KeywordTok{proj4string}\NormalTok{(ewsResults) <-}
\StringTok{    }\NormalTok{sp}\OperatorTok{::}\KeywordTok{CRS}\NormalTok{(}\StringTok{"+proj=longlat +datum=WGS84"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\hypertarget{visualize-results-one-regime-detection-metric-at-a-time}{%
\subsection{Visualize results: one regime detection metric at a time}\label{visualize-results-one-regime-detection-metric-at-a-time}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Specify results to visualize}
\NormalTok{plotResults <-}\StringTok{ }\NormalTok{distResults}

\CommentTok{# Which metric do we want to visualize}
\NormalTok{metric.ind <-}\StringTok{ "s"}

\CommentTok{# Sort the years}
\NormalTok{year.ind <-}\StringTok{ }\KeywordTok{unique}\NormalTok{(plotResults}\OperatorTok{@}\NormalTok{data}\OperatorTok{$}\NormalTok{year) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{sort}\NormalTok{()}

\CommentTok{# Create a label for plotting, depending on direction}
\NormalTok{sortVar.lab <-}
\StringTok{    }\KeywordTok{ifelse}\NormalTok{(}\KeywordTok{unique}\NormalTok{(plotResults}\OperatorTok{@}\NormalTok{data}\OperatorTok{$}\NormalTok{direction) }\OperatorTok{==}\StringTok{ "South-North"}\NormalTok{,}

...
\addcontentsline{toc}{chapter}{Appendix A: R package regimeDetectionMeasures}
...
\includegraphics{_myDissertation_files/figure-latex/unnamed-chunk-5-1.pdf}
\begin{verbatim}
Warning: Removed 1 rows containing missing values (geom_path).
\end{verbatim}
\includegraphics{_myDissertation_files/figure-latex/unnamed-chunk-6-1.pdf}

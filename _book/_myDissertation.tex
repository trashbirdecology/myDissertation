...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{journal =} \KeywordTok{ifelse}\NormalTok{(label }\OperatorTok{==}\StringTok{"rodionov_sequential_2005"}\NormalTok{, }\StringTok{"Other"}\NormalTok{, journal), }
         ...
         \DataTypeTok{journal =} \KeywordTok{ifelse}\NormalTok{(journal }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\OtherTok{NA}\NormalTok{, }\StringTok{"NA"}\NormalTok{), }\StringTok{"Other"}\NormalTok{, journal)) }\OperatorTok{%>%}\StringTok{ }
...
\NormalTok{FI_}\FloatTok{7.3}\NormalTok{b <-}\StringTok{ }\NormalTok{caTools}\OperatorTok{::}\KeywordTok{trapz}\NormalTok{(s[ind], (}\DecValTok{1}\OperatorTok{/}\NormalTok{p[ind])}\OperatorTok{*}\NormalTok{dpds[ind]}\OperatorTok{^}\DecValTok{2}\NormalTok{)}
...
\NormalTok{ind <-}\StringTok{ }\DecValTok{1}\OperatorTok{:}\NormalTok{(}\KeywordTok{length}\NormalTok{(s)}\OperatorTok{-}\DecValTok{1}\NormalTok{)}
\NormalTok{FI_}\FloatTok{7.3}\NormalTok{c <-}\StringTok{ }\DecValTok{4}\OperatorTok{*}\NormalTok{caTools}\OperatorTok{::}\KeywordTok{trapz}\NormalTok{(s[ind], dqds[ind]}\OperatorTok{^}\DecValTok{2}\NormalTok{)}
...
\NormalTok{  dpds <-}\StringTok{ }\NormalTok{dp}\OperatorTok{/}\NormalTok{ds}
\NormalTok{  ind <-}\StringTok{ }\DecValTok{1}\OperatorTok{:}\NormalTok{(}\KeywordTok{length}\NormalTok{(s)}\OperatorTok{-}\DecValTok{1}\NormalTok{)}
\NormalTok{  FI_}\FloatTok{7.3}\NormalTok{b[i] <-}\StringTok{ }\NormalTok{caTools}\OperatorTok{::}\KeywordTok{trapz}\NormalTok{(s[ind], (}\DecValTok{1}\OperatorTok{/}\NormalTok{p[ind])}\OperatorTok{*}\NormalTok{dpds[ind]}\OperatorTok{^}\DecValTok{2}\NormalTok{)}

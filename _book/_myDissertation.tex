...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./chapterFiles/fiGuide/figures/stringFig} \caption{A single cycle of a hypothetical two-species system over time period $t = 0$ to $t = T$. $s^*$ is the state of the system at some point in time. The dotted line represents the distance travelled by the system in phase space over its trajectory during time $(0, T)$.}\label{fig:stringFig}
\end{figure}
...
\NormalTok{sPlot <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(df, dist, }\DataTypeTok{div =} \DecValTok{10}\NormalTok{)\{}
  \ControlFlowTok{if}\NormalTok{(}\StringTok{"sortVar"} \OperatorTok{%in%}\StringTok{ }\KeywordTok{names}\NormalTok{(dist))dist <-}\StringTok{ }\NormalTok{dist }\OperatorTok{%>%}\StringTok{ }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{t =}\NormalTok{ sortVar)}
...
\NormalTok{dist <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{cellID =} \DecValTok{1}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{sortVar =}\NormalTok{ t) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{regimeDetectionMeasures}\OperatorTok{::}\KeywordTok{calculate_distanceTravelled}\NormalTok{()}
\KeywordTok{dsdtPlot}\NormalTok{(}\DataTypeTok{dist=}\NormalTok{dist, }\DataTypeTok{df=}\NormalTok{df, }\DataTypeTok{div =} \DecValTok{1}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}
  \KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"changing means, constant variance"}\NormalTok{))}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ dist.sim }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(sim.num}\OperatorTok{==}\DecValTok{666}\NormalTok{, t}\OperatorTok{==}\DecValTok{51}\NormalTok{), }
       \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \KeywordTok{as.integer}\NormalTok{(mean.sim), }\DataTypeTok{y =}\NormalTok{ dsdt))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{()}\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_bw}\NormalTok{()}\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"velocity, "}\NormalTok{,}\KeywordTok{italic}\NormalTok{(}\StringTok{"v"}\NormalTok{), }\StringTok{" at "}\NormalTok{, }\KeywordTok{italic}\NormalTok{(}\StringTok{"t = 51"}\NormalTok{))))}\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"total change in "}\NormalTok{, }\KeywordTok{bar}\NormalTok{(}\StringTok{"x"}\NormalTok{)[}\DecValTok{1}\NormalTok{], }\StringTok{" at "}\NormalTok{, }\KeywordTok{italic}\NormalTok{(}\StringTok{"t = 50"}\NormalTok{))))}
\end{Highlighting}
\end{Shaded}
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dist.sim.reduced <-}\StringTok{ }\NormalTok{dist.sim }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(t}\OperatorTok{==}\DecValTok{51}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{         }\KeywordTok{group_by}\NormalTok{(mean.sim) }\OperatorTok{%>%}\StringTok{ }
\StringTok{         }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{dsdt.sim.mean  =} \KeywordTok{mean}\NormalTok{(dsdt), }
                \DataTypeTok{sd.sim    =} \KeywordTok{sd}\NormalTok{(dsdt), }
                \DataTypeTok{lower     =}\NormalTok{ dsdt.sim.mean }\OperatorTok{-}\StringTok{ }\FloatTok{1.96}\OperatorTok{*}\NormalTok{sd.sim, }
                \DataTypeTok{upper     =}\NormalTok{ dsdt.sim.mean }\OperatorTok{+}\StringTok{ }\FloatTok{1.96}\OperatorTok{*}\NormalTok{sd.sim}
\NormalTok{                ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{         }\KeywordTok{distinct}\NormalTok{(mean.sim, sd.sim, lower, upper, dsdt.sim.mean) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{mean.sim =} \KeywordTok{as.integer}\NormalTok{(mean.sim))}

\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ dist.sim.reduced)}\OperatorTok{+}
\StringTok{ }\KeywordTok{geom_ribbon}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ mean.sim, }\DataTypeTok{ymin =}\NormalTok{ lower , }\DataTypeTok{ymax =}\NormalTok{ upper), }\DataTypeTok{fill =} \StringTok{"grey70"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ mean.sim,  }\DataTypeTok{y =}\NormalTok{ dsdt.sim.mean))}\OperatorTok{+}
\StringTok{    }\KeywordTok{theme_bw}\NormalTok{()}\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"velocity, "}\NormalTok{,}\KeywordTok{italic}\NormalTok{(}\StringTok{"v"}\NormalTok{), }\StringTok{" at "}\NormalTok{, }\KeywordTok{italic}\NormalTok{(}\StringTok{"t = 51"}\NormalTok{))))}\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"total change in "}\NormalTok{, }\KeywordTok{bar}\NormalTok{(}\StringTok{"x"}\NormalTok{)[}\DecValTok{1}\NormalTok{], }\StringTok{" between "}\NormalTok{, }\KeywordTok{italic}\NormalTok{(}\StringTok{"t = 50"}\NormalTok{), }\StringTok{" and "}\NormalTok{, }\KeywordTok{italic}\NormalTok{(}\StringTok{"t = 51"}\NormalTok{))))}\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"Mean "}\NormalTok{,  }\KeywordTok{italic}\NormalTok{(}\StringTok{"v"}\NormalTok{),}\StringTok{" ($}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{pm 2$ SD) over "}\NormalTok{, }\DecValTok{10}\NormalTok{,}\DecValTok{000}\NormalTok{, }\StringTok{" iterations"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
\begin{figure}
\centering
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{files <-}\StringTok{ }\KeywordTok{list.files}\NormalTok{(}\StringTok{"./chapterFiles/velocity/simResults"}\NormalTok{, }\DataTypeTok{pattern=} \StringTok{"var_x1"}\NormalTok{)}

\ControlFlowTok{if}\NormalTok{(quickRun) files <-}\StringTok{ }\NormalTok{files[}\DecValTok{1}\OperatorTok{:}\DecValTok{500}\NormalTok{] }\CommentTok{# when knitting thesis for minor edits...}

\ControlFlowTok{if}\NormalTok{(}\KeywordTok{length}\NormalTok{(files) }\OperatorTok{==}\DecValTok{0}\NormalTok{)\{}
\NormalTok{  var.analy =}\StringTok{ }\OtherTok{TRUE}
  \KeywordTok{source}\NormalTok{(}\StringTok{"./chapterFiles/velocity/06-chap-velocity_exampleAnalysis.R"}\NormalTok{)}
\NormalTok{\}}
\NormalTok{dist.sim <-}\StringTok{ }\KeywordTok{do.call}\NormalTok{(}\StringTok{"rbind"}\NormalTok{, }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{"./chapterFiles/velocity/simResults/"}\NormalTok{,files),}
\NormalTok{        feather}\OperatorTok{::}\NormalTok{read_feather))}
...
\NormalTok{dist.sim.reduced <-}\StringTok{ }\NormalTok{dist.sim }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(t}\OperatorTok{==}\DecValTok{51}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{         }\KeywordTok{group_by}\NormalTok{(var.sim) }\OperatorTok{%>%}\StringTok{ }
\StringTok{         }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{dsdt.sim.mean  =} \KeywordTok{mean}\NormalTok{(dsdt), }
                \DataTypeTok{sd.sim    =} \KeywordTok{sd}\NormalTok{(dsdt), }
                \DataTypeTok{lower     =}\NormalTok{ dsdt.sim.mean }\OperatorTok{-}\StringTok{ }\FloatTok{1.96}\OperatorTok{*}\NormalTok{sd.sim, }
                \DataTypeTok{upper     =}\NormalTok{ dsdt.sim.mean }\OperatorTok{+}\StringTok{ }\FloatTok{1.96}\OperatorTok{*}\NormalTok{sd.sim}
\NormalTok{                ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{         }\KeywordTok{distinct}\NormalTok{(var.sim, sd.sim, lower, upper, dsdt.sim.mean) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{var.sim =} \KeywordTok{as.integer}\NormalTok{(var.sim))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ dist.sim }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(sim.num}\OperatorTok{==}\DecValTok{666}\NormalTok{, t}\OperatorTok{==}\DecValTok{51}\NormalTok{), }
       \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \KeywordTok{as.integer}\NormalTok{(var.sim), }\DataTypeTok{y =}\NormalTok{ dsdt))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{()}\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_bw}\NormalTok{()}\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"velocity, "}\NormalTok{,}\KeywordTok{italic}\NormalTok{(}\StringTok{"v"}\NormalTok{), }\StringTok{" at "}\NormalTok{, }\KeywordTok{italic}\NormalTok{(}\StringTok{"t = 51"}\NormalTok{))))}\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\KeywordTok{italic}\NormalTok{(}\StringTok{"W"}\NormalTok{), }\StringTok{"total change in "}\NormalTok{, }\StringTok{"sigma"}\NormalTok{[}\DecValTok{1}\NormalTok{], }\StringTok{" at "}\NormalTok{, }\KeywordTok{italic}\NormalTok{(}\StringTok{"t = 50"}\NormalTok{))))}
\end{Highlighting}
\end{Shaded}
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ dist.sim.reduced) }\OperatorTok{+}
\StringTok{ }\KeywordTok{geom_ribbon}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ var.sim, }\DataTypeTok{ymin =}\NormalTok{ lower , }\DataTypeTok{ymax =}\NormalTok{ upper), }\DataTypeTok{fill =} \StringTok{"grey70"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ var.sim,  }\DataTypeTok{y =}\NormalTok{ dsdt.sim.mean))}\OperatorTok{+}
\StringTok{    }\KeywordTok{theme_bw}\NormalTok{()}\OperatorTok{+}
\StringTok{  }\KeywordTok{xlim}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{25}\NormalTok{))}\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"velocity, "}\NormalTok{,}\KeywordTok{italic}\NormalTok{(}\StringTok{"v"}\NormalTok{), }\StringTok{" at "}\NormalTok{, }\KeywordTok{italic}\NormalTok{(}\StringTok{"t = 51"}\NormalTok{))))}\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(sigma, }\StringTok{" "}\NormalTok{, }\KeywordTok{bar}\NormalTok{(}\StringTok{"x"}\NormalTok{)[}\DecValTok{1}\NormalTok{], }\StringTok{" at "}\NormalTok{, }\KeywordTok{italic}\NormalTok{(}\StringTok{"t = 50"}\NormalTok{))))}\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"Mean "}\NormalTok{,  }\KeywordTok{italic}\NormalTok{(}\StringTok{"v"}\NormalTok{),}\StringTok{" ($}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{pm 2$ SD) over "}\NormalTok{, }\DecValTok{10}\NormalTok{,}\DecValTok{000}\NormalTok{, }\StringTok{" iterations"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
\begin{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x_}\DecValTok{1}\NormalTok{ =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{mean =} \DecValTok{25}\NormalTok{, }\DataTypeTok{sd =} \DecValTok{2}\NormalTok{, }\DataTypeTok{n=}\DecValTok{50}\NormalTok{), }\KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{mean =}\DecValTok{100}\NormalTok{, }\DataTypeTok{sd =} \DecValTok{10}\NormalTok{, }\DataTypeTok{n=}\DecValTok{50}\NormalTok{))}
\NormalTok{x_}\DecValTok{2}\NormalTok{ =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{mean =} \DecValTok{50}\NormalTok{, }\DataTypeTok{sd =} \DecValTok{5}\NormalTok{, }\DataTypeTok{n=}\DecValTok{50}\NormalTok{), }\KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{mean =}\DecValTok{10}\NormalTok{, }\DataTypeTok{sd =} \DecValTok{10}\NormalTok{, }\DataTypeTok{n=}\DecValTok{50}\NormalTok{))}
\NormalTok{t =}\StringTok{ }\DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(x_}\DecValTok{1}\NormalTok{)}
\NormalTok{df  =}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(t, x_}\DecValTok{1}\NormalTok{, x_}\DecValTok{2}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{tidyr}\OperatorTok{::}\KeywordTok{gather}\NormalTok{(}\DataTypeTok{key =} \StringTok{"variable"}\NormalTok{, }\DataTypeTok{value =} \StringTok{"value"}\NormalTok{, }\OperatorTok{-}\NormalTok{t) }
\NormalTok{dist <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }
...
\KeywordTok{dsdtPlot}\NormalTok{(}\DataTypeTok{dist=}\NormalTok{dist, }\DataTypeTok{df=}\NormalTok{df, }\DataTypeTok{div =} \DecValTok{1}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}
  \KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"change in mean & variance (x"}\NormalTok{[}\DecValTok{1}\NormalTok{], }\StringTok{", x"}\NormalTok{[}\DecValTok{2}\NormalTok{], }\StringTok{")"}\NormalTok{))}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\begin{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x_}\DecValTok{1}\NormalTok{ =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{mean =} \DecValTok{25}\NormalTok{, }\DataTypeTok{sd =} \DecValTok{2}\NormalTok{, }\DataTypeTok{n=}\DecValTok{50}\NormalTok{), }\KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{mean =}\DecValTok{25}\NormalTok{, }\DataTypeTok{sd =} \DecValTok{12}\NormalTok{, }\DataTypeTok{n=}\DecValTok{50}\NormalTok{))}
\NormalTok{x_}\DecValTok{2}\NormalTok{ =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{mean =} \DecValTok{50}\NormalTok{, }\DataTypeTok{sd =} \DecValTok{5}\NormalTok{, }\DataTypeTok{n=}\DecValTok{50}\NormalTok{), }\KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{mean =}\DecValTok{50}\NormalTok{, }\DataTypeTok{sd =} \DecValTok{5}\NormalTok{, }\DataTypeTok{n=}\DecValTok{50}\NormalTok{))}
\NormalTok{t =}\StringTok{ }\DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(x_}\DecValTok{1}\NormalTok{)}
\NormalTok{df  =}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(t, x_}\DecValTok{1}\NormalTok{, x_}\DecValTok{2}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{tidyr}\OperatorTok{::}\KeywordTok{gather}\NormalTok{(}\DataTypeTok{key =} \StringTok{"variable"}\NormalTok{, }\DataTypeTok{value =} \StringTok{"value"}\NormalTok{, }\OperatorTok{-}\NormalTok{t) }
\NormalTok{dist <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }
...
\KeywordTok{dsdtPlot}\NormalTok{(}\DataTypeTok{dist=}\NormalTok{dist, }\DataTypeTok{df=}\NormalTok{df, }\DataTypeTok{div =} \DecValTok{1}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}
  \KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"constant mean, variance increase (x"}\NormalTok{[}\DecValTok{1}\NormalTok{], }\StringTok{")"}\NormalTok{))}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\begin{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x_}\DecValTok{1}\NormalTok{ =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{mean =} \DecValTok{25}\NormalTok{, }\DataTypeTok{sd =} \DecValTok{25}\NormalTok{, }\DataTypeTok{n=}\DecValTok{50}\NormalTok{), }\KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{mean =}\DecValTok{50}\NormalTok{, }\DataTypeTok{sd =} \DecValTok{50}\NormalTok{, }\DataTypeTok{n=}\DecValTok{50}\NormalTok{))}
\NormalTok{x_}\DecValTok{2}\NormalTok{ =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{mean =} \DecValTok{15}\NormalTok{, }\DataTypeTok{sd =} \DecValTok{15}\NormalTok{, }\DataTypeTok{n=}\DecValTok{50}\NormalTok{), }\KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{mean =}\DecValTok{150}\NormalTok{, }\DataTypeTok{sd =} \DecValTok{150}\NormalTok{, }\DataTypeTok{n=}\DecValTok{50}\NormalTok{))}
\NormalTok{t =}\StringTok{ }\DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(x_}\DecValTok{1}\NormalTok{)}
\NormalTok{df  =}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(t, x_}\DecValTok{1}\NormalTok{, x_}\DecValTok{2}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{tidyr}\OperatorTok{::}\KeywordTok{gather}\NormalTok{(}\DataTypeTok{key =} \StringTok{"variable"}\NormalTok{, }\DataTypeTok{value =} \StringTok{"value"}\NormalTok{, }\OperatorTok{-}\NormalTok{t) }
\NormalTok{dist <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }
...
\KeywordTok{dsdtPlot}\NormalTok{(}\DataTypeTok{dist=}\NormalTok{dist, }\DataTypeTok{df=}\NormalTok{df, }\DataTypeTok{div =} \DecValTok{1}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}
  \KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"changing means, variance = mean"}\NormalTok{))}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\begin{figure}

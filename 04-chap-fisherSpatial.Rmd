...
```{r usaFI, echo = FALSE, out.width="95%", fig.cap="Fisher Information of 5 East-West spatial transects over time. Adjacent changes of blue to red or vice-versa indicate regime shifts"}

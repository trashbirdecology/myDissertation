...
I calculated FI using Equation \@ref(eq:derivativesFI) for every South-North and East-West transect (see Figs. \@ref(fig:bbsPoints), \@ref(fig:ewRouteMap)) for every year between 1975 and 2018. 

...
```{r bbsPoints,echo = FALSE,   fig.cap = 'Locations of Breeding Bird Survey routes sampled between 1966 and 2017.'}
...
```{r ewRouteMap, echo = FALSE,  fig.cap = 'A single East-West transect of Breeding Bird Survey routes used to calculate the Fisher Information.'}
...
```{r ewRoutesUsedHere, echo = FALSE, fig.align='center',  fig.cap = 'The three East-West running transects used to visualize results in this chapter.'}
...
```{r oneTsectEx, echo = FALSE, fig.align='center',  fig.cap = 'An example of two adjacent spatial transects within my sampling grid. After Fisher Ifnomration was calculated within a single transect, correlations were then calculated to determine the relationship among transect-pairs.'}
knitr::include_graphics(paste0(figDissDir, "/transectSamplingEx_1row.png"))
```
...
```{r adjacentTsectEx, echo = FALSE, fig.align='center',  fig.cap = "An example of two adjacent spatial transects (12, 13) within my sampling grid. After Fisher Ifnomration was calculated within a single transect, correlations were then calculated to determine the relationship among transect-pairs."}
...
```{r fi1Tsect, echo = FALSE,  fig.cap="Fisher Information calculated for a single transect over time."}
knitr::include_graphics(paste0(figDissDir,  "/transect_12_East-West_metric_FI_Eqn7_12.png"))
```

```{r usaFI, eval=FALSE, echo = FALSE,  fig.cap="Fisher Information of 5 East-West spatial transects over time. Adjacent changes of blue to red or vice-versa indicate regime shifts"}
...
```{r fiEcoregion00, echo = FALSE,  fig.cap="Fisher Information (scaled and centered; point size positively correlated with value) along spatial transects, plotted against ecoregion boundaries (EPA Level 2)."}

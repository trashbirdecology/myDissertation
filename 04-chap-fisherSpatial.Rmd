<<<<<<< HEAD:04-chap-fisherSpatial.Rmd
---
output:
...
---
```{r include=FALSE}
source('/chapterFiles/fisherSpatial/04-chap-fisherSpatial.R')
=======
```{r include=T, cache=T}
...
>>>>>>> 69efe78d309af914c60c0660767c3bc43f749492:04-chap-binning.Rmd
```
...
It is time to move these methods into a more operational, rather than theoretical, space. Testing these suggested RSDMs on empirical data is vital to this goal. 
...
Fisher Information was introduced as a potential method for 

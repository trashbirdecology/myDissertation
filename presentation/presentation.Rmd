...
# Two Primay Steps in Calculating Fisher Information: Dimension Reduction & Fisher Information <!-- 2-step calculation-->
...
.right-column-2[.medium[2) Fisher &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Information]]
...
# Chapter 3: Two-species Predator Prey Model System <!-- CH3-->

.left-column-half[.small-med[
- Outline the calculation steps 

- Highlight the  __dimension reduction__ step as alternative to Fisher Information

- Demonstrate on 2-species predator-prey model
...
# Step 1: Distance Travelled <!-- CH3 Step 1b-->
...
# Step 2a: Calculate Velocity & Acceleration of Distance Travelled 


.left-column-2[
.small[<b>Velocity</b> (below)]<br>
<img src="figures/predpreydsdt.png" width="550">
]
???
- Further, we can calculate the velocity of the distance travelled, 
--
.right-column-2[.medium[
<br><br>
...
# Step 2b: Calculate Fisher Information Based on the Velocity & Acceleration of Distance Travelled 

.left-column-2[<img src="figures/fiwinsize.png" width="660">]
.right-column-2[.small-med[
- Requires user-defined parameters

- Sensitive to window size parameter

- Velocity vs. FI .tiny[(Ch. 6) ]

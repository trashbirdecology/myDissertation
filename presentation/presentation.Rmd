...
- Altered atmospheric conditions __click__
...
???
- Disturbing rate of global warming ....

- Already has had detrimental consequences...__click__ 
...
???
- We, society + science are recognizing the impacts that our actions are  having 
---
...
- Luckily, just like this guy -- 
  - some consequences may be avoidable
--

<br>.center[.big[__Can we foresee undesirable changes?__]]

???
- And this is a big ??? in ecology right now--
- Can we foresee and perhaps avoid undesirable change in ecological systems?

---
# Ecological Regime Shifts  <!-- what how goal -->
???
- Scientific community is attempting to foresee undesirable changes
- Develop + apply  concept of __ecological regime shifts__ ... next
--
...
--
<br><br><br>
.big[**goal?** detect or predict in time to prevent or mitigate]
???
...
???
- Regime shifts are  important when _impacts human societies_, livelihoods, and health
--
...
.center[<img src="figures/methodflow.png" width="500">]

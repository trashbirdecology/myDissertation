...
### Generating the data
Here we consider a two-variable system over the time interval $[1,100]$ with state variables $x_1$ and $x_2$ which exhibits abrupt shifts in mean and/or variance of one or both variables at time $t=50$. I generated species observations across the time interval by drawing from a normal distribution. 

I generated a single datset for each of the six conditions explored explored six conditions (Table \@ref(tab:sysParams))

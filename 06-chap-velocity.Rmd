...
# if(purrr::is_empty(list.files(here::here("chapterFiles/velocity/figsCalledInDiss/")))){source("./chapterFiles/velocity/06-chap-velocity_makeplots.R")}
```
## Introduction
...
knitr::include_graphics(here::here("chapterFiles/velocity/figsCalledInDiss/sysEx.png"))
```
...
```{r sysEx2,   cache = TRUE, echo=FALSE, warning=FALSE, eval=TRUE, message=FALSE,  out.width="85%", fig.cap="Data used to calculate velocity at the first two time points, $t_1$ and $t_2$."}
 knitr::include_graphics(here::here("chapterFiles/velocity/figsCalledInDiss/sysEx2.png"))
```
...
```{r sysExs, cache = TRUE, echo=FALSE, warning=FALSE, eval=TRUE, message=FALSE,  out.width="85%", fig.cap = "Distance traveled, $s$, for the 2-species toy system."}
 knitr::include_graphics(here::here("chapterFiles/velocity/figsCalledInDiss/sysExs.png"))
```
...
df.wide <- readRDS(file = here::here("/chapterFiles/velocity/dfwide_table.RDS"))
...
knitr::include_graphics(here::here("chapterFiles/velocity/figsCalledInDiss/velocSysEx2.png"))
```
\newpage
...
knitr::include_graphics(here::here("chapterFiles/velocity/figsCalledInDiss/velocSysEx3.png"))
```
\newpage
...
knitr::include_graphics(here::here("chapterFiles/velocity/figsCalledInDiss/velocSysEx4.png"))
```